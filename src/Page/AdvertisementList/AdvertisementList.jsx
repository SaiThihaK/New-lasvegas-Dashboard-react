...
const AdvertisementList = () => {
  ...
  return (
    <PageCard>
      <div style={btnStyle}>
        <Button size='small' variant='contained' onClick={openHandler}>
          အသစ်ဖန်တီးရန်
        </Button>
      </div>
        ...
        {AdvertiselistData.map((data, index) => (
          <TableRow key={index}>
            ...
            <TableCell align='center'>
              <img src={data.url} alt='img' width='200' />
            </TableCell>
            <TableCell align='center'>
...
export const AdvertiselistData = [
  {
    no: '1',
    title:
      'Lorem ipsum dolor sit amet consectetur adipisicing elit. In est numquam explicabo sit quam adipisci eos deserunt nihil nam pariatur itaque veniam vitae dolores sed, voluptates eius officia laborum recusandae?',
