...
const Master = () => {
  ...
  const data = [];
  const { data: master, loading } = CustomGetFunction('api/agents?sortColumn=id&sortDirection=desc&limit=30&agent_level=master', []);
  console.log(master);
  return (
    <PageCard title="ဂုတ်စီးများ">
      <div className={classes["btn-container"]}>
        <Button variant="contained" size="small" onClick={() => navigate("/dashboard/createMaster")}>ဖန်တီးရန်</Button>
      </div>
            ...
            <TableRow key={index}>
              ...
              <TableCell align="center">
                <Stack direction="row" spacing={1}>
                  ...
                  <Button variant="contained" color="error" size="small">ပိတ်ရန်</Button>
                </Stack>
              </TableCell>
            </TableRow>
          ))
...
const columns = ['စဥ်', 'အမည်', 'ကိုယ်စားလှယ်ယူထားသည်များ', 'ရာခိုင်နှုန်း', 'အပြင်အဆင်', "မှတ်ချက်"];
