...
const Tab1 = () => {
    ...
    // Close Time
    const [closeDate, setCloseDate] = React.useState(new Date('2014-08-18T21:11:54'));
    const closeDateHandler = (newValue) => {
      setCloseDate(newValue);
    };

    const [closeTime, setCloseTime] = React.useState(new Date('2014-08-18T21:11:54'));
  ...
  <p>တစ်လတစ်ကြိမ်ပြင်ဆင်ပေးရန်။မပြင်ပါကထိုးသားမထိုးလို့ရတော့မည်မဟုတ်ပါ။
  </p>
</Stack>
<Stack style={stackStyle} direction="row" spacing={2}>
  <label style={{width:200,marginTop:10}}>လက်ခံမည့်ပမာဏ</label>
  <TextField  label="ယူနစ်" sx={{width:300}} />
</Stack>
<Stack style={stackStyle} direction="row" spacing={2}>
  <label style={{width:200,marginTop:10}}>၁၆ရက်ပိတ်</label>
  <Switchbutton />
</Stack>
<Stack style={stackStyle} direction="row" spacing={2}>
